<div class="container">
    <div class="row">
        ...
        <div class="column-12">
            ...
            <form action="<?php echo site_url('admin/produk/update/' . $product_row['id_product']) ?>" method="post"
                enctype="multipart/form-data">
                <div class="form-group">
                    <label>Nama Produk</label>
                    <input type="text" class="form-control" name="product_name"
                        value="<?php echo $product_row['product_name'] ?>" required="">
                </div>
                <div class="form-group">
                    <label>Harga Produk</label>
                    <input type="number" class="form-control" name="product_price"
                        value="<?php echo $product_row['product_price'] ?>" required="">
                </div>
                <div class="form-group">
                    <label>Gambar Produk</label>
                    <br>
                    <img src="<?php echo base_url('images/' . $product_row['product_image']) ?>" width="150">
                    <br>
                    <br>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="product_description"
                        required=""><?php echo $product_row['product_description'] ?></textarea>
                </div>
                <div class="form-group">
